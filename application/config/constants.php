...
define('REGISTERED_EMAIL', 'Email address already registered with us');
define('REGISTERED_USERNAME', 'Username is already registered with us');
define('ERROR_SOMETHING_WENT_WRONG', 'Something went wrong, please try again');
define('PASSWORDS_ERROR', 'Both passwords should be matched');